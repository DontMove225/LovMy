                  ...
                  children: [
                    RichText(text: TextSpan(
                        children: [
                          ...
                          TextSpan(text: AppLocalizations.of(context)?.translate("LovMy") ?? "LovMy",style: Theme.of(context).textTheme.bodyMedium!.copyWith(fontSize: 20,color: AppColors.appColor,fontWeight: FontWeight.bold)),
                        ]
                    )),
