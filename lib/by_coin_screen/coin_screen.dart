...
import 'package:lovmy/by_coin_screen/coin_history.dart';
                                                                      ...
                                                                      children: [
                                                                        mainpayment <= 0.0 ? Expanded(child: MainButton(
                                                                          ...
                                                                          if (premiumProvider.selectedPayment == 1) {
                                                                            ...
                                                                            // https://lovmy.fr/flutterwave/index.php?amt=500&email=alicesmith@gmail.com
                                                                          ...
                                                                          // https://lovmy.fr/result.php?detail=Movers&amount=500.0&order_id=501592598&name=propi&email=propi@gmail.com&phone=8686868686
                                                                          // 14
                                                                          // https://lovmy.fr/detail=Movers&amount=500.0&order_id=234205222&name=propi&email=propi@gmail.com&phone=8686868686
                                                                        ...
                                                                        children: <Widget>[
                                                                          ...
                                                                          walleteProvider.walletReportApiModel.wallet == "0" ? const SizedBox() :  Row(
                                                                            children: [
                                                                              ...
                                                                              const SizedBox(width: 10,),
                                                                              Expanded(
                                                                                child: switchValue ?  Text("My Wallet (${Provider.of<HomeProvider>(context,listen: false).currency}$walletMain)",overflow: TextOverflow.ellipsis,maxLines: 1,) : Text("My Wallet (${Provider.of<HomeProvider>(context,listen: false).currency}${walleteProvider.walletReportApiModel.wallet})",overflow: TextOverflow.ellipsis,maxLines: 1,),
                                                                              ),
                                                                              Transform.scale(
                                                                                scale: 0.8,
