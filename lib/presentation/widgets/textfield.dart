...
class TextFieldPro extends StatelessWidget {
  ...
  const TextFieldPro(
      ...
      this.surfixOntap,
      this.obscureText, this.svgColor, this.textColor});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      style: textColor != null ? Theme.of(context).textTheme.bodyMedium!.copyWith(color: textColor) : Theme.of(context).textTheme.bodyMedium,
