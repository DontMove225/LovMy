...
import 'package:lovmy/presentation/firebase/videocall_screen.dart';
import 'package:lovmy/presentation/screens/AudioCall/audiocall_screen.dart';
...
class _PickUpCallState extends State<PickUpCall> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Container(
        decoration: const BoxDecoration(gradient: AppColors.gradientCall),
        child: Column(
          children: [
            const Spacer(flex: 2),
            Container(
