...
import 'package:lovmy/data/models/detailsmodel.dart';
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        InkWell(
                          onTap: () async {
                            final newValue = await BlocProvider.of<MatchCubit>(context).toggleFavoriteApi(
                              uid: Provider.of<HomeProvider>(context, listen: false).uid,
                              profileId: detailProvider.detailModel.profileinfo!.profileId.toString(),
                            );
                            detailProvider.updateIsFavorite(newValue);
                          },
                          child: Container(height: 55,width: 55,decoration: BoxDecoration(
                              shape: BoxShape.circle,
                              color: detailProvider.isFavorite ? AppColors.appColor : Colors.white
                          ),child: Center(child: Icon(
                            detailProvider.isFavorite ? Icons.bookmark : Icons.bookmark_border,
                            color: detailProvider.isFavorite ? Colors.white : AppColors.black,
                          )),),
                        ),
