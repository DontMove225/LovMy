...
import 'package:lovmy/Logic/cubits/premium_cubit/premium_bloc.dart';
import 'package:lovmy/Logic/cubits/premium_cubit/premium_state.dart';
                                           ...
                                           MainButton(
                                             ...
                                             if (premiumProvider.selectedPayment == 1) {
                                               ...
                                               byCoinProvider.stripeCheckoutApi(
                                                 context: context,
                                                 type: "plan",
                                                 itemId: premiumProvider.selectedPlan.toString(),
                                               ).then((checkoutUrl) {
