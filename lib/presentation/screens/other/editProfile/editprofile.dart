...
import 'package:lovmy/Logic/cubits/editProfile_cubit/editprofile_state.dart';
              ...
              if(editProvider.mobileNumber.text.compareTo(Provider.of<HomeProvider>(context,listen: false).userlocalData.userLogin!.mobile!) != 0){
                ...
                if(onbordingCubit.smaTypeApiModel?.otpAuth == "Yes"){
                   ...
                   if (onbordingCubit.smaTypeApiModel?.smsType == "Msg91") {
                                          ...
                                          MainButton(
                                            ...
                                            onTap: () async {
                                              ...
                                              final verified = await onbordingCubit.verifyMsgOtpApi(
                                                mobile: "+${editProvider.ccode}${editProvider.mobileNumber.text}",
                                                otp: editProvider.otp,
                                              );
                    ...
                    // Fallback: smsType inconnu → continuer sans OTP
