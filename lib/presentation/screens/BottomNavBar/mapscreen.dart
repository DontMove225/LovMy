...
class _MapScreenState extends State<MapScreen> {
  ...
  fun(){
    final profiles = homeProvider.mapModel.profilelist;
    ...
    setState(() {
      Future.delayed(
        const Duration(seconds: 1),() {
          ...
          updateMarker(
            context: context,
            profileuimage: "assets/icons/Pin.png",
            id: profiles[0].profileId,
            lat1: double.tryParse(profiles[0].profileLat.toString()) ?? 0.0,
            long1: double.tryParse(profiles[0].profileLongs.toString()) ?? 0.0,
            title: profiles[0].profileName ?? '',
            subTitle: profiles[0].profileBio ?? '',
          );
      },);
    });
  }
                ...
                children: [
                  ...
                  Center(
                    child: Container(
                      ...
                      child: Text(
                        AppLocalizations.of(context)?.translate("No users in your area") ?? "Aucun utilisateur n'est dans votre zone",
