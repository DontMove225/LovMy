...
import 'package:lovmy/firebase_accesstoken.dart';
                ...
                Row(
                  children: [
                    homeProvider.userlocalData.userLogin?.profilePic != null ? Container(
                      ...
                      child: Center(child: Text(homeProvider.userlocalData.userLogin?.name?.isNotEmpty == true ? "${homeProvider.userlocalData.userLogin!.name![0]}" : "?",style: const TextStyle(fontSize: 20,fontWeight: FontWeight.bold),)),
                    ),
              ...
              return Center(
                child: Padding(
                  ...
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Icon(Icons.wifi_off_rounded, size: 60, color: AppColors.appColor),
                      ...
                      ElevatedButton.icon(
                        ...
                        onPressed: () => BlocProvider.of<HomePageCubit>(context).initforHome(context),
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        image: state.homeData.profilelist![nextIndex].safeImages.isNotEmpty
                                            ? DecorationImage(
                                                image: NetworkImage("${Config.baseUrl}${state.homeData.profilelist![nextIndex].safeImages.first}"),
                                                fit: BoxFit.cover)
                                            : null,
                                    ),
                                  ),
                                                        ...
                                                        children: [
                                                          ...
                                                          SizedBox(
                                                            ...
                                                            child: CircularProgressIndicator(
                                                                ...
                                                                value: ((state.homeData.profilelist![nextIndex].matchRatio ?? 80).toDouble() / 100)
                                                            ),
                                                          ),
                                                          ...
                                                          Text("${(state.homeData.profilelist![nextIndex].matchRatio ?? 80).toStringAsFixed(0)}%", style: Theme.of(context).textTheme.bodySmall!.copyWith(color: Colors.white),),
                                  ...
                                  state.homeData.profilelist![nextIndex].safeImages.length> 1?  SizedBox(
                                    height: 25,
                                    width : MediaQuery.of(context).size.width,
                                    child: Row(
                                      mainAxisAlignment: MainAxisAlignment.center,
                                      children: [
                                        ...
                                        ...List.generate(
                                            state.homeData.profilelist![nextIndex].safeImages.length,
                                                (index) {
                                              return Indicator(
                                            ...
                                            child: Stack(
                                              children: [
                                                ...
                                                CarouselSlider.builder(
                                                  itemCount: state.homeData.profilelist![homeProvider.currentIndex].safeImages.isNotEmpty
                                                      ? state.homeData.profilelist![homeProvider.currentIndex].safeImages.length
                                                      : 1,
                                                  ...
                                                  itemBuilder: (BuildContext context, int itemIndex, int pageViewIndex) {
                                                    ...
                                                    return Container(
                                                      ...
                                                      width: MediaQuery.of(context).size.width,
                                                      decoration: BoxDecoration(
                                                          image: state.homeData.profilelist![homeProvider.currentIndex].safeImages.isNotEmpty
                                                              ? DecorationImage(image: NetworkImage("${Config.baseUrl}${state.homeData.profilelist![homeProvider.currentIndex].safeImages[itemIndex]}"), fit: BoxFit.cover)
                                                              : null,
                                                  ...
                                                  options: CarouselOptions(
                                                      autoPlay: state.homeData.profilelist![homeProvider.currentIndex].safeImages.length > 1? true : false,
                                                      enableInfiniteScroll: state.homeData.profilelist![homeProvider.currentIndex].safeImages.length > 1? true : false,
                                                      height: MediaQuery.of(context).size.height / 1.45,
                                                      onPageChanged: (i, r) {
                                                ...
                                                if (homeProvider.activeSwipeFeedback != null)
                                                  Center(
                                                    child: SizedBox(
                                                      height: 140,
                                                      width: 140,
                                                      child: Lottie.asset(
                                                        homeProvider.activeSwipeFeedback == SwipeFeedback.like
                                                            ? 'assets/lottie/swipe_like.json'
                                                            : 'assets/lottie/swipe_pass.json',
                                                        repeat: false,
                                                      ),
                                                    ),
                                                  ),
                                                                          ...
                                                                          children: [
                                                                            SizedBox(
                                                                              ...
                                                                              child: CircularProgressIndicator(
                                                                                  backgroundColor: Colors.white.withOpacity(0.3),
                                                                                  valueColor: const AlwaysStoppedAnimation(Colors.white),
                                                                                  value: ((state.homeData.profilelist![homeProvider.currentIndex].matchRatio ?? 80).toDouble() / 100)
                                                                              ),
                                                                            ),
                                                                            Text(
                                                                              "${(state.homeData.profilelist![homeProvider.currentIndex].matchRatio ?? 80).toStringAsFixed(0)}%",
                                                ...
                                                state.homeData.profilelist![homeProvider.currentIndex].safeImages.length > 1? SizedBox(
                                                  height: 25,
                                                  width: MediaQuery.of(context).size.width,
                                                  child: Row(
                                                    mainAxisAlignment: MainAxisAlignment.center,
                                                    children: [
                                                      ...
                                                      ...List.generate(
                                                          state.homeData.profilelist![homeProvider.currentIndex].safeImages.length, (index) {
                                                        return Indicator(
                                      ...
                                      child: (i == 2 && state.homeData.planId != "0") ? (state.homeData.directChat == "1") ? InkWell(
                                        onTap: () {
                                          ...
                                          Navigator.push(context, MaterialPageRoute(builder: (context) => ChattingPage(
                                            proPic: state.homeData.profilelist![homeProvider.currentIndex].safeImages.isNotEmpty
                                                ? state.homeData.profilelist![homeProvider.currentIndex].safeImages.first
                                                : "",
