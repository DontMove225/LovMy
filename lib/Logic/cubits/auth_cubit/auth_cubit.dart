  ...
  Future<void> signInWithGoogle(context) async {
    try {
      ...
      if (userCredential.user != null) {
        // Note : pas de vérification côté serveur pour l'instant (côté front
        // uniquement) — chaque connexion Google ouvre le flow d'inscription
        // pré-rempli, même si un compte existe déjà avec cet email.
