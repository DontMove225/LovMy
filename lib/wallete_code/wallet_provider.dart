...
import 'package:lovmy/wallete_code/wallet_report_api_model.dart';
import 'package:lovmy/wallete_code/wallete_screen.dart';
import 'package:lovmy/wallete_code/walletup_api_model.dart';
...
class WalleteProvider extends ChangeNotifier {
            ...
            return Container(
              ...
              child: Column(
                children: [
                  ...
                  CircleAvatar(radius: 35,backgroundColor: AppColors.appColor,child: const Center(child: Icon(Icons.check,color: Colors.white,)),),
                  const SizedBox(height: 20,),
  ...
  Future walletreportApi({context}) async{
    ...
    try{
      ...
      // En cas d'erreur, on affiche quand même le profil
      islaoding = true;
      notifyListeners();
    }
  }
