            ...
            <>
              ...
              <form className="space-y-5" onSubmit={handleSendOtp}>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full rounded-2xl bg-gradient-passion px-5 py-3 text-sm font-semibold text-white shadow-[0_12px_30px_rgba(235,6,3,0.35)] transition hover:brightness-110 disabled:opacity-60"
                >
